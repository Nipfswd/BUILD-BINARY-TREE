...
Tor Browser 15.0a3 - September 18 2025
 * All Platforms
   * Updated Tor to 0.4.9.3-alpha
   * Updated OpenSSL to 3.5.3
   * Bug 43009: Backport Bug 1973265 - Put WebCodecs API behind RFP Target [tor-browser]
   * Bug 43093: Refactor the patch to disable LaterRun [tor-browser]
   * Bug 43745: Review Mozilla 1842838:  [meta] HEVC (H265) playback related bugs. See the support status on the User Story. [tor-browser]
   ...
   * Bug 41429: Add a note about user safety to Tor Browser Alpha blog posts [tor-browser-build]
   * Bug 41563: Do not copy Noto Color Emoji on Windows [tor-browser-build]
 * Windows + macOS + Linux
 ...
 * All Platforms
   ...
   * Bug 44000: Rebase Tor Browse Alpha onto 140.1.0esr [tor-browser]
   * Bug 41502: Application services build is failing on isNetworkAllowed() [tor-browser-build]
   * Bug 41508: Switch built-in meek bridge to meek-unredacted [tor-browser-build]
   * Bug 41515: Bump version of Conjure to include P173 improvements [tor-browser-build]
 * Windows + macOS + Linux
   ...
   * Bug 43905: base-browser.ftl missing from about:addons [tor-browser]
   * Bug 43906: Extension.sys.mjs change in the wrong commit [tor-browser]
   * Bug 43913: Bizarre right-clicking issues: menu items blanked out and/or not working; too many items in the right-click menu; different right-clicking menu displayed initially for links [tor-browser]
   * Bug 43929: two about:tor pages opened after update [tor-browser]
   * Bug 43930: Onionize toggle not centre aligned in about:tor [tor-browser]
   * Bug 43947: Console error from ContentBlockingPrefs.init [tor-browser]
   * Bug 43989: Switch off AI chatbot preference [tor-browser]
 * Android
   ...
   * Bug 43577: Flush settings fails on Android [tor-browser]
   * Bug 43786: Add new UX flow for changing security level (Android) [tor-browser]
   * Bug 43855: brand.properties merging on Android is broken in 140 [tor-browser]
   * Bug 44029: Search/url bar doesn't work on android after ESR 140 [tor-browser]
   * Bug 44036: Crash on opening "Search Settings" on android [tor-browser]
   * Bug 41494: Update GeckoView build scripts for ESR140 [tor-browser-build]
 * Build System
   * All Platforms
     ...
     * Bug 41227: Update projects/common/list_toolchain_updates-common-firefox-geckoview to include check for binutils [tor-browser-build]
     * Bug 41432: Bump OpenSSL to >= 3.5.0 [tor-browser-build]
     * Bug 41434: Go updates shouldn't target all platforms until macOS is on legacy in the changelogs [tor-browser-build]
   ...
   * Android
     * Bug 43984: Update android build scripts and docs for ESR 140 [tor-browser]
     * Bug 43987: 140 Android is not reproducible [tor-browser]
     * Bug 41280: download-android-<arch>.json does not get updated for android-only releases [tor-browser-build]
     * Bug 41453: Update application-services and uniffi-rs for ESR140 [tor-browser-build]
     * Bug 41483: geckoview_example-withGeckoBinaries-....apk doesn't exist anymore in Firefox 140 [tor-browser-build]
     * Bug 41484: Create a fork of application-services [tor-browser-build]
     * Bug 41499: Android nightly builds are broken [tor-browser-build]
     * Bug 41500: Optimize tor and its dependencies for size on Android [tor-browser-build]
     * Bug 41506: Use appilcation-services branch for nightlies builds [tor-browser-build]
     * Bug 41507: Single-arch build fails because artifacts don't have arch subdirectories [tor-browser-build]
 ...
 * All Platforms
   ...
   * Bug 43443: Drop effective top level domain for `au.securedrop.tor.onion` [tor-browser]
   * Bug 43585: Rebase Tor Browser alpha onto 128.9.0esr [tor-browser]
   ...
   * Bug 41425: Snowflake needs to be listed separately on torrc-defaults [tor-browser-build]
 * Windows + macOS + Linux
...
Tor Browser 14.5a5 - March 21 2025
 * All Platforms
   ...
   * Bug 43556: Update Desktop and Android survey dismissal string [tor-browser]
 ...
 * Android
   ...
   * Bug 43505: Implement User Survey UX (Android) [tor-browser]
 * Build System
   * All Platforms
   ...
   * Android
     * Bug 41402: Fix Snowflake 2.11.0 on Android [tor-browser-build]
 ...
 * All Platforms
   ...
   * Bug 43449: Rebase Tor Browser alpha onto 128.7.0esr [tor-browser]
 ...
 * Windows + macOS + Linux
   ...
   * Bug 41831: Some .tor.onion sites are not displaying the underlying V3 onion address in alpha [tor-browser]
   ...
   * Bug 43406: 2 buttons displayed onion-available and connect when Tor daemon killed [tor-browser]
 ...
 * Android
   ...
   * Bug 43360: [Android] Replace custom variable isBeingRecreated with built-in isFinishing function [tor-browser]
 ...
 * Build System
   * All Platforms
     ...
     * Bug 41345: Go autoupdates in 1.23 so add env var to prevent it in any step that has network access [tor-browser-build]
     * Bug 41357: keyring/anti-censorship.gpg is in `GPG keybox database version 1` format [tor-browser-build]
...
Tor Browser 13.5.7 - October 08 2024
 * All Platforms
   * Bug 43201: Security fixes from Firefox 131.0.2 [tor-browser]
   * Bug 361: SSL_ERROR_NO_CYPHER_OVERLAP on some Brazilian government websites [mullvad-browser]
 * Build System
   * Windows + macOS + Linux
     * Bug 41254: Drop cryptoSafetyPrompt.properties line [tor-browser-build]
 ...
 * Windows + macOS + Linux
   ...
   * Bug 43149: Update donate URL in YEC 2024 desktop [tor-browser]
 ...
 * All Platforms
   ...
   * Bug 42277: Enable storage.sync to fix broken webextensions [tor-browser]
   * Bug 42288: Allow language spoofing in status messages [tor-browser]
   * Bug 42302: The allowed ports string contains a typo [tor-browser]
 * Windows + macOS + Linux
 ...
 * Android
   ...
   * Bug 41846: firefox-android esr 115 introduced new nimbus use: they need to be disabled [tor-browser]
   * Bug 42074: YEC 2023 Takeover for Android Stable [tor-browser]
   * Bug 42258: Replace the current boring "fiery android" icon we use for dev with the cool nightly icon [tor-browser]
   * Bug 42259: Remove unused firefox branding from Tor Browser for Android [tor-browser]
   * Bug 42260: Add TBB artifacts to .gitignore [tor-browser]
   * Bug 42285: Update the gitignore to use the correct paths for tor stuff [tor-browser]
   * Bug 42287: Backport security fixes (Android & wontfix) from Firefox 120 to 115.5 - based Tor Browser [tor-browser]
 * Build System
   * All Platforms
     * Update Go to 1.21.4
     * Bug 40884: Script to automate uploading sha256s and signatures to location signing/download-unsigned-sha256sums-gpg-signatures-from-people-tpo expects them to be [tor-browser-build]
 ...
 * All Platforms
   ...
   * Updated tor to 0.4.8.9
   * Bug 42275: Rebase Tor Browser Stable to 115.5.0esr [tor-browser]
   * Bug 42277: Enable storage.sync to fix broken webextensions [tor-browser]
 * Windows + macOS + Linux
   * Updated Firefox to 115.5.0esr
...
Tor Browser 13.0a6 - September 29 2023
 * All Platforms
   * Updated tor to 0.4.8.7
   * Updated Translations
   * Bug 42139: Backport security fixes from Firefox 115.3.1 to 115.3.0 [tor-browser]
 * Windows + macOS + Linux
   * Bug 40899: Fix all of our usage of `app.support.baseURL` [tor-browser]
   * Bug 41165: Crash with debug assertions enabled [tor-browser]
   * Bug 41910: Support link regression in 115.1.0esr [tor-browser]
   * Bug 42100: Connect Assist dropdown text not centered [tor-browser]
   * Bug 42129: Disable the Tor restart prompt if shouldStartAndOwnTor is false [tor-browser]s
   * Bug 42131: Tor Browser 13.0a5 does not track circuits created before Tor Browser started [tor-browser]
   * Bug 42132: The new control port handling in Tor Browser 13 breaks a Tails security feature [tor-browser]
 * Windows
   * Bug 40954: Implement Windows installer icons [tor-browser-build]
   * Bug 42087: Implement Windows application icons [tor-browser]
 * Android
   * Bug 42023: TB13.0a2 android: remove FF what's new [tor-browser]
   * Bug 42114: Disable Allow sharing current tab URL from Android's Recents screen in private browsing mode [tor-browser]
   * Bug 42115: Enhanced Tracking Protection can still be enabled [tor-browser]
   * Bug 42133: Remove "Total Cookie Protection" popup [tor-browser]
   * Bug 42134: Remove Android icon shortcuts [tor-browser]
 ...
 * Android
   ...
   * Bug 41928: Backport Android-specific security fixes from Firefox 116 to ESR 102.14 / 115.1 - based Tor Browser [tor-browser]
   * Bug 41972: Disable Firefox onboarding in 13.0 [tor-browser]
   * Bug 41997: Remove all use and reference to com.adjust.sdk.Adjust which now uses AD_ID [tor-browser]
 * Build System
   * All Platforms
     * Updated Go to 1.20.7
     * Bug 31588: Be smarter about vendoring for Rust projects [tor-browser-build]
 ...
 * All Platforms
   ...
   * Bug 41351: Move the crypto protection patch earlier in the patchset [tor-browser]
   * Bug 41361: Integrate the Conjure PT into alpha versions of Tor Browser [tor-browser]
 ...
 * Build System
   ...
   * Linux
     * Bug 40731: Update namecoin patches to apply in tor-browser nightly [tor-browser-build]
   * Android
